document.getElementById('lang-toggle').addEventListener('click', function (event) {
	...
	// Cambia el texto del botón de idioma según el contenido actual
	var currentLang = this.textContent.trim();
	if (currentLang === "FR") {
		this.textContent = "EN"; // Cambia el botón a "EN" cuando esté en francés
		changeLanguage("fr");    // Cambia los contenidos a francés
	} else {
		this.textContent = "FR"; // Cambia el botón a "FR" cuando esté en inglés
		changeLanguage("en");    // Cambia los contenidos a inglés
	}
});
...
const translations = {
	en: {
		...
		"bannerTitle": "Hi I'm Ivan<br>I love to create web apps",
	...
	fr: {
		...
		"bannerTitle": "Salut, je suis Ivan<br>J'adore créer des applications web",
